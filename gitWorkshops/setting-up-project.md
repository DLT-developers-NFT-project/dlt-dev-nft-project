...
Amazing. Now for the next step go to the [tutorial](https://github.com/GigaHierz/dlt-dev-nft-project/blob/main/gitWorkshops/git-hub-basics.md) on how to add stuff to the repository, how to create your own branch and how to merge it into the main branch.
